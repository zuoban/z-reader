...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
      ref={ref}
      className={cn(
        'paper-motion-interactive relative flex w-full cursor-default select-none items-center rounded-xl py-2 pl-2.5 pr-8 text-sm outline-none focus:bg-muted/70 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        className
      )}
    {...props}
  >
